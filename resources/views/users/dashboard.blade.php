 ...
 <div id="menu-detail" class="modal fade" role="dialog">
  ...
  <tbody>
    ...
    <tr>
     ...
     <tr>
      <td colspan="4" style="text-align: center;"><b>Range usia</b></td>
      <td id="dt_range_usia">2</td>
    </tr>
    <tr>
      ...
      var table = $('#table-menu').DataTable({
          ...
          columns    : [
                         ...
                         // {data : 'harga_menu',name : 'harga_menu'},
                          ...
                          {render : function(data, type, full, meta)
                            {
                                return  " <button id='btnUpdate' style='margin-top : 2px;' href='#' data-id="+full.id_menu+" class='btn btn-info'>Detail Data</button>";
                            }
                        }
                       ]
      ...
      table.on('order.dt search.dt',function(){
          ...
          $('#table-menu').on('click','[id=btnUpdate]', function(){
             ...
             //     alert(id);
                    ...
                    $.ajax({
                            url      : baseUrl + '/user/backend/get_menu_detail/'+id,
                            type     : 'GET',
                            dataType : 'JSON',
